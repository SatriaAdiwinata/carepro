        ...
        <div class="lg:col-span-1">
            ...
            <div class="sticky top-24">
                ...
                <div class="space-y-4">
                    ...
                    <a href="{{ route('news.show', $item->slug) }}" class="group block border rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
                        ...
                        <div class="relative w-full h-24 overflow-hidden">
                            ...
                            <p class="absolute bottom-0 right-0 bg-black bg-opacity-50 text-white text-xs px-2 py-0.5 rounded-tl-lg">
                        ...
                        <div class="p-2"> 
                            ...
                            <h3 class="font-semibold text-sm text-gray-800 line-clamp-2 group-hover:text-purple-600 transition-colors">
                                {{ $item->judul }}
                            </h3>
