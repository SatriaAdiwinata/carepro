            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="border border-gray-200 rounded-lg p-6">
                    ...
                    <div class="mt-4 flex space-x-2">
                        {{-- UPDATE: Ganti href untuk mengarah ke route show --}}
                        <a href="{{ route('admin.companies.show', 1) }}" 
                ...
                <div class="border border-gray-200 rounded-lg p-6">
                    ...
                    <div class="mt-4 flex space-x-2">
                        {{-- UPDATE: Ganti href untuk mengarah ke route show --}}
                        <a href="{{ route('admin.companies.show', 2) }}" 
                           class="px-3 py-1 text-xs bg-blue-100 text-blue-800 rounded hover:bg-blue-200 transition-colors">
                            Lihat Detail
                        </a>
                        <button class="px-3 py-1 text-xs bg-gray-100 text-gray-800 rounded">Hapus</button>
                ...
                <div class="border border-gray-200 rounded-lg p-6">
                    ...
                    <div class="mt-4 flex space-x-2">
                        {{-- UPDATE: Ganti href untuk mengarah ke route show --}}
                        <a href="{{ route('admin.companies.show', 3) }}" 
                           class="px-3 py-1 text-xs bg-blue-100 text-blue-800 rounded hover:bg-blue-200 transition-colors">
                            Lihat Detail
                        </a>
                        <button class="px-3 py-1 text-xs bg-gray-100 text-gray-800 rounded">Hapus</button>
