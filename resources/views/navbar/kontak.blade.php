...
<section class="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row items-start gap-8">
    ...
    <div class="w-full md:w-2/3 h-64 md:h-96 rounded-md overflow-hidden shadow-md">
        <iframe
